...
//			gl_usage = GL_STREAM_DRAW;
	...
	int SpriteBatch::add(float x, float y, float a, float sx/* = 1*/, float sy/* = 1*/, 
	...
	int SpriteBatch::addq(love::graphics::Quad * quad, float x, float y, float a, float sx/* = 1*/, float sy/* = 1*/, 
		float ox/* = 0*/, float oy/* = 0*/, float kx/* = 0*/, float ky/* = 0*/, int index/* = -1*/)
	{
		// Only do this if there's a free slot.
	...
	void SpriteBatch::draw(float x /*= 0*/, float y /*= 0*/, float angle /*= 0*/, float sx /*= 1*/, float sy /*= 1*/, 
