...
#include <image/null/ImageData.h>
...
namespace opengl
{
	...
	**/
	...
	private:
		...
		love::image::null::ImageData * data;
	...
	public:
		...
		**/
		Image(love::image::ImageData * data, bool noColor = false);
