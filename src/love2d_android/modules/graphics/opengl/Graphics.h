...
*	11. toggleFullscreen()
*	12. reset(), present(), setIcon(), setCaption(), getCaption()
*	13. polygon()'s DRAW_FILL
**/
...
namespace love
{
	namespace image { class Image; class ImageData;}
	namespace filesystem { class File; }
	namespace image { class ImageData; }
	namespace font { class Font; class Rasterizer; }
...
namespace opengl
{
	...
	public:
		...
		**/
		 ...
		 **/
		void setDefaultImageFilter(const graphics::Image::Filter& f);
		...
		**/
		 ...
		 **/
		const graphics::Image::Filter& getDefaultImageFilter() const;
